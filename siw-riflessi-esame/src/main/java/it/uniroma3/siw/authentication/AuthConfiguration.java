...
<<<<<<< HEAD
        .antMatchers(HttpMethod.GET, "/", "/index","/location/**","/membroStaff/**" ,"/evento/**","/portataMenu/**", "/login", "/css/**", "/img/**","/pdf/**").permitAll()
=======
        .antMatchers(HttpMethod.GET, "/", "/index","/location/**","/membroStaff/**" ,"/evento/**","/menu/**", "/login", "/css/**", "/img/**").permitAll()
>>>>>>> main
